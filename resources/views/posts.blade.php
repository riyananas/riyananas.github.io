    ...
    <div class="col-md-6">
        <form action="/posts">
            ...
            <div class="input-group my-3">
                <input type="text" class="form-control" placeholder="Input keyword.." name="search" value="{{ request('search') }}">
...
@if ($posts->count())
<div class="card my-4 py-4 justify-content-center">
    @if ($posts[0]->image)
        <div style="max-height: 400px; overflow:hidden;" class="justify-content-center">
